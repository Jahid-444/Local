...
│ ╭──────────────────────────────────────────────────────────────────────────────────╮ │
│ │                                                                                  │ │
│ │                •   STATUS : PRIBADI WHATSAPP : 01865508461  •                 │ │
│ │                •                          │ │
│ │                •        JAHID     •                 │ │
│ │                •        JAHID        •                 │ │
│ │                •          JAHID     •                 │ │
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/Jahid-444/Local/blob/main/Approval.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        os.system('xdg-open https://wa.me/+01865508461?text=Assalamualaikum Sir Approve my Token and my Token :'+to)
        reg()
...
def reg2():
    ...
    print (' TOKEN : ' + id)
    print(' WHATSAPP : 01865508461')
    input(' Press Enter To Send Token ')
    os.system('xdg-open https://wa.me/+01865508461?text=Assalamualaikum Sir Approve my Token and my Token :'+id)
...
def chigozie():
    ...
    if cookie in['OPEN','Open','open']:
      jalan("\n  %s* %sanda akan di arahkan ke YouTube"%(O,O));time.sleep(3);os.system('xdg-open https://wa.me/+01865508461');chigozie()
    try:
        ...
        os.system('xdg-open https://wa.me/+01865508461')
        bsn_menu()
...
def bsn_menu():
    ...
    print(" [*]. WP             +01865508461       ");time.sleep (0.03)
    print(" [*]. This Tool was made in Pakistan                 ");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
    print(" [*] COMING ( A D F )    ");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
        ...
        try:
            for pw in __chi__:
                ...
                header = {
                    ...
                    "accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exJAHIDe;v=b3;q=0.9",
                    "dnt":"1",
